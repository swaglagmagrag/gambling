...
function begin() 
  ...
  local f = "Oooh, looks like you're out of money! You can earn more by typing mines."
  if name == "" then 
    print(a) 
    name = io.read()
    return begin() 
...
firsttime = true 
function mines() 
  local a = "Welcome to the mines " .. name .. "! Here, you have to type the letter than shows up on the screen, each letter you get correct will give you $1."
  local b = "Welcome back " .. name .. "!"
  local c = "Not much more I can help you with here, just type the correct letters to earn some extra cash! Type back when you would like to return"
